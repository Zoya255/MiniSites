...
4)  Структура базы данных
	...
	Таблица `cons`
		...
		id, id преподавателя, дата / время, продолжительность

	Таблица `prepodpars`
		Хранит связи между преподавателями и проводимыми ими предметами
		id, id преподавателя, id пары
	...
	Таблица `otdelgroups`
		...
		id, id отделения, id группы

	Таблица `otdelenie`
		Хранит все отделения техникума
		id, название отделения
